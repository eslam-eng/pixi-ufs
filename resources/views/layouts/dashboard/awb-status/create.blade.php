...
@section('content')
    ...
    {{--    breadcrumb --}}
    @include('layouts.components.breadcrumb',['title' => trans('app.awb_status_title'),'first_list_item' => trans('app.prices'),'last_list_item' => trans('app.add_status')])
    {{--    end breadcrumb --}}
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12"> <!--div-->
            <div class="card">
                <div class="card-body">
                    <form action="{{route('awb-status.store')}}" method="post">
                        @csrf
                        ...
                        <div class="row row-sm mb-4">
                            ...
                            <div class="col-lg">
                                ...
                                <input class="form-control" value="{{old('sms')}}" name="sms" placeholder="@lang('app.sms')"
                                       type="text">
                                @error('sms')
                                <div class="text-danger"> {{$message}}</div>
                                @enderror
