...
mix.js('resources/assets/js/JsBarcode.all.min.js', 'public/assets/js')
mix.js('resources/assets/js/qrcode.min.js', 'public/assets/js')
mix.js('resources/assets/js/tooltip.js', 'public/assets/js')
mix.js('resources/assets/js/awb/create-awb.js', 'public/assets/js')
