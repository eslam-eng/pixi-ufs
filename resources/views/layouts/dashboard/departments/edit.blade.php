...
@section('content')
    ...
    {{--    breadcrumb --}}
    @include('layouts.components.breadcrumb',['title' => trans('departments_page_title'),'first_list_item' => trans('app.departments'),'last_list_item' => trans('app.add_department')])
    {{--    end breadcrumb --}}
