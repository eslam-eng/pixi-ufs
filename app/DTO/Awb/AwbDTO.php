...
class AwbDTO extends BaseDTO
{
    ...
    public function __construct(
        ...
        public ?int        $receiver_city_id,
        public ?int        $receiver_area_id,
    ...
    public static function fromRequest($request): BaseDTO
    {
        return new self(
            ...
            receiver_city_id: $request->receiver_city_id,
    ...
    public static function fromArray(array $data): BaseDTO
    {
        return new self(
            ...
            receiver_city_id: Arr::get($data, 'receiver_city_id'),
            receiver_area_id: Arr::get($data, 'receiver_area_id'),
    ...
    public function toArray(): array
    {
        return [
            ...
            "receiver_area_id" => $this->receiver_area_id,
