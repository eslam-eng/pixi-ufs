...
class CompaniesDatatable extends DataTable
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('email')->title(trans('app.email'))->orderable(false)->searchable(false),
            Column::make('ceo')->title(trans('app.ceo'))->orderable(false)->searchable(false),
            Column::make('phone')->title(trans('app.phone'))->orderable(false),
            Column::make('show_dashboard')->title(trans('app.show_dashboard'))->orderable(false)->searchable(false),
            Column::make('notes')->title(trans('app.notes'))->searchable(false)->orderable(false)->searchable(false),
            Column::make('status')->title(trans('app.status'))->searchable(false)->orderable(false)->searchable(false),
            ...
            Column::make('city_id')->title(trans('app.city'))->orderable(false)->searchable(false),
            Column::make('area_id')->title(trans('app.area'))->orderable(false)->searchable(false),
